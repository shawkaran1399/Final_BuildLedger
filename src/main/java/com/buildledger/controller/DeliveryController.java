...
public class DeliveryController {
    ...
    @Operation(summary = "Record delivery [ADMIN, PROJECT_MANAGER, VENDOR]",
               description = "✅ ADMIN, PROJECT_MANAGER, VENDOR can record deliveries.\n❌ CLIENT cannot record deliveries.")
    ...
    @Operation(summary = "Update delivery status [ADMIN, PROJECT_MANAGER]",
               description = "✅ ADMIN, PROJECT_MANAGER can accept or reject deliveries.\n❌ VENDOR cannot change delivery status.")
